...
void Sceneo2::calcAverageNormals(unsigned int* indices, unsigned int indiceCount, GLfloat* vertices, unsigned int verticeCount,
...
void Sceneo2::TransformAndRenderModel(Modelo2* m, Materialo2* mat, GLfloat transX, GLfloat transY, GLfloat transZ, GLfloat scale, GLfloat rotX, GLfloat rotY, GLfloat rotZ)
{
...
void Sceneo2::TransformAndRenderMesh(Mesho2* m, Materialo2* mat, GLfloat transX, GLfloat transY, GLfloat transZ, GLfloat scale, GLfloat rotX, GLfloat rotY, GLfloat rotZ)
{
	glm::mat4 model = glm::mat4(1.0f);
	model = glm::translate(model, glm::vec3(transX, transY, transZ));
	model = glm::rotate(model, rotX * toRadians, glm::vec3(1, 0, 0));
...
void Sceneo2::DirectionalShadowMapPass()
{
...
void Sceneo2::RenderPass(glm::mat4 viewMatrix)
{
...
void Sceneo2::Init()
{
	...
	mainLight = DirectionalLighto2(2048, 2048,
		1.0f, 1.0f, 1.0f,
		0.1f, 0.3f,
		0.0f, -15.0f, -10.0f);

	pointLights[0] = PointLighto2(1.0f, 1.0f, .8f,
		0.0f, 0.1f,
		0.0f, 0.0f, 0.0f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;
	pointLights[1] = PointLighto2(1.0f, 1.0f, 0.8f,
		0.0f, 0.1f,
		-4.0f, 2.0f, 0.0f,
		0.3f, 0.1f, 0.1f);
	pointLightCount++;

	spotLights[0] = SpotLighto2(1.0f, 1.0f, .8f,
		-.0f, 1.0f,
		-1.0f, 5.0f, -7.0f,
		0.0f, -1.0f, 0.0f,
		1.0f, 0.0f, 0.0f,
		40.0f);
	spotLightCount++;
	spotLights[1] = SpotLighto2(1.0f, 1.0f, 1.0f,
		0.0f, 0.5f,
		0.0f, -1.5f, 0.0f,
		-10.0f, 2.0f, -7.0f,
		1.0f, 0.0f, 0.0f,
		30.0f);
	spotLightCount++;
	spotLights[2] = SpotLighto2(1.0f, 1.0f, 1.0f,
		0.0f, 0.5f,
		0.0f, 1.5f, 0.0f,
		10.0f, -1.0f, -8.0f,
		1.0f, 0.0f, 0.0f,
